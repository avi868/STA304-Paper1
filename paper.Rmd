...
# Data
This data was sourced from City of Toronto open data portal using `opendatatoronto`package [@citeopendatatoronto].  Graphs and tables were plotted using R software [@citeR] and the tidyverse package [@citetidyverse]. Tables were drawn using the knitr package [@citeknitr] Data that uses population estimates were calculated using estimates from Environics Analytics. It should be noted that these estimates only took into consideration local residents, so no commuters etc., were taken into account. In addition, it is known that a substantial number of crimes go unreported.  All data were obtained from the Toronto Police Service and no private or personal information were used in this data set. 
...
```{r plots1, fig.cap="Crime Rates from 2014 to 2020", message=FALSE, echo=FALSE}
...
```{r plot2, fig.cap="Auto-theft Rates from 2014 to 2020", echo= FALSE}
...
```{r plot3, fig.cap="Breaking and Entering Rates from 2014 to 2020", echo=FALSE}
...
```{r plot4, fig.cap="Homicide Rates from 2014 to 2020", echo=FALSE}
